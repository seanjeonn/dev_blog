...
date: 2026-03-09
published: true
tags: ["AI Agent", "Context Engineering", "AGENTS.md", "LLM", "Coding Agent", "Developer Productivity"]
category: "AI"
toc: true
---
...
<Callout type="info" title="On the Impact of AGENTS.md Files on the Efficiency of AI Coding Agents (arXiv:2601.20404)">
...
<Callout type="warning" title="Evaluating AGENTS.md: Are Repository-Level Context Files Helpful for Coding Agents? (arXiv:2602.11988)">
...
<Callout type="info" title="Agent READMEs: An Empirical Study of Context Files for Agentic Coding (arXiv:2511.12884)">
...
**Context Engineering for AI Agents in OSS** 연구에서는 OSS repository의 context file을 대규모로 분석한 결과, context file이 agent 행동을 **강하게 유도**하며 repository-specific context가 workflow에 큰 영향을 미친다는 것을 발견했습니다.

**결론**: context는 **knowledge가 아니라 agent behavior control layer**로 작동합니다.

### 2-5. Agent 설정 도구로의 진화

**Configuring Agentic AI Coding Tools: Exploratory Study**에서는 다양한 coding agent 설정을 비교 분석했습니다. Repository context file adoption이 증가하고 있으며, CLAUDE.md, AGENTS.md 같은 agent-specific config가 확산되고 있다는 결과를 보여줍니다.

**결론**: context file은 **configuration artifact**로 진화하고 있습니다.

### 2-6. 실행 가능한 규칙의 필요성

<Callout type="tip" title="ContextCov: Executable Constraints from Agent Instruction Files">
