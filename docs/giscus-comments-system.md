...
│  ┌────────────────────────────────────────────────────────┐ │
│  │ API Routes                                              │ │
│  │  - POST /api/sync-comments?all=true                    │ │
...
# 4. 수동 동기화
curl -X POST http://localhost:3000/api/sync-comments?all=true \
...
```bash
# 모든 포스트 동기화
curl -X POST https://yourdomain.com/api/sync-comments?all=true \
  -H "Authorization: Bearer your_cron_secret"

# 특정 포스트 동기화
curl -X POST https://yourdomain.com/api/sync-comments?slug=hello-world \
  -H "Authorization: Bearer your_cron_secret"
```
